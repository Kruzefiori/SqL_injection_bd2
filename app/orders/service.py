from framework.service import GenericService, GenericServiceInjection
from .repository import OrderRepository, OrdersRepositoryInjection
...
class OrderServiceInjection(GenericService):
    def __init__(self):
        super().__init__(OrdersRepositoryInjection)
